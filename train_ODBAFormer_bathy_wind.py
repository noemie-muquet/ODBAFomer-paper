...
import pandas as pd
from dataloaders.bathy_wind_dataloader import ODBADataModule, ODBATestDataModule
    ...
    def save_vis_step_end(
        ...
        if self.local_rank == 0:
            ...
            if batch_idx in example_data_idx_list:
                ...
                im5 = ax[0,2].imshow(bt, cmap='GnBu', interpolation='nearest', vmax = -np.min(bt))
                ax[0,2].set_title('Normalized Bathymetry')
